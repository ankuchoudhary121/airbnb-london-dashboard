...
st.markdown("""
Here you can explore **pricing**, **availability**, and **host behaviour** 
...
if "All" not in selected_room:
    df_filtered = df_filtered[
        df_filtered["room_type"].isin(selected_room)
    ]
...
st.subheader("📍 Neighbourhood & Listings")
